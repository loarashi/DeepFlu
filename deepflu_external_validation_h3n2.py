...
train_Features=all_Features[:34]#提取訓練資料的特徵
train_Label=all_Label[:34]#提取訓練資料的標籤
test_Features=all_Features[21:]#提取測試資料的特徵
test_Label=all_Label[21:]#提取測試資料的標籤
...
predict=all_probability[21:]#提取測試資料的預測標籤
predict_score=all_probability_score[21:]#提取測試資料的預測機率
