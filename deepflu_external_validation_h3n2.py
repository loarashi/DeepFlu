...
all_df = pd.read_csv("data/external_validation_data/73072_H3N2_external_validation_D2_D5.txt",sep='\t',encoding='utf-8')
...
train_Features=all_Features[:34]
train_Label=all_Label[:34]
test_Features=all_Features[21:]
test_Label=all_Label[21:]
...
predict=all_probability[21:]
predict_score=all_probability_score[21:]
